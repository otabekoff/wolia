...
- At the end of the task do use `cargo clippy --workspace`, deny, `cargo test --workspace`, `cargo check --workspace`, `cargo build --workspace` commands and if problems, fix them.
